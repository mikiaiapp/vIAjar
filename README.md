...
3. Tener los puertos **6666** (Frontend) y **8000** (Opcional, API Backend) libres y mapeados adecuadamente si utilizas un proxy inverso.
...
Una vez terminado, podrás acceder a la aplicación web a través de la IP de tu Synology NAS en el puerto `6666`. (Ejemplo: `http://192.168.1.100:6666`).
